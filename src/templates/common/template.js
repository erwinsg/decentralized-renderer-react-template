...
export const SOR_TRANSCRIPT_FONT_SIZE_12 = css`
  fontSize: 12px;
  fontFamily: Arial;
`;

export const SOR_TRANSCRIPT_FONT_SIZE_11 = css`
  fontSize: 11px;
  fontFamily: Arial;
  lineHeight: 2.0;
`;

export const SOR_INDENT_TEXT = css`
  marginLeft: 0.5em;
`;

export const EXAM_LVL_TEXT = css`
  fontSize: 11px;
  fontFamily: Arial;
  lineHeight: 2.0;
  marginLeft: 4.2em;
...
const FORMATDATEPREFIX = (dateString) => {
...
export const GETIDENTIFICATION = document => {
  const fin = get(document, "recipient.fin");
  const nric = get(document, "recipient.nric");
  const passportNumber = get(document, "recipient.passportNumber");
...
export const GETSUBJGRADE = (subjgrade, examyr, examlvltype) => {
  ...
  return (
    <div className="row">
      <div className="col-md-6" css={SOR_CENTER_ALIGN}>
        {alphaRender}
      </div>
      <div className="col-md-6" css={SOR_CENTER_ALIGN}>
        {numericRender}
...
export const EXAMININGAUTHORITYANDLANGUAGEMEDIUMHEADER = (
  ...
  if (examlvltype === "A3") {
    return (
      <div className="row">
        <div className="col-md-2" css={SOR_50_WIDTH}>
          EXAMINING <br />
          AUTHORITY
        </div>
      </div>
...
export const EXAMGRADEHEADER = (examlvltype, examyr) => {
  if (examlvltype === "A3") {
    return (
      <div className="row" css={SOR_BOLD_TEXT}>
  ...
  return (
    <div className="row" css={SOR_BOLD_TEXT}>
      <div className="col-md-4">SUBJECT</div>
      <div className="col-md-2" css={SOR_CENTER_ALIGN}>
        <div className="row">
          <div className="col-md-12">GRADE</div>
        </div>
        <div className="row">
          <div className="col-md-6" css={SOR_SUBJECT_MARGIN_ALPHABET}>
            ALPHABETICAL
          </div>
          <div className="col-md-6" css={SOR_SUBJECT_MARGIN_NUMERICAL}>
            NUMERICAL
          </div>
        </div>
      </div>
      <div className="col-md-2" css={SOR_30_WIDTH}>
        LEVEL
      </div>
...
export const SUBJECTGRADE = (
  ...
  if (examlvltype === "PSLE1979") {
    return (
      <div className="row">
        <div className="col-md-3" />
        <div className="col-md-3" css={SOR_PSLE_GRADE_1979}>
          {grade}
        </div>
      </div>
    );
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-3" css={SOR_30_WIDTH}>
        {level}
      </div>
      <div className="col-md-6">
        {EXAMININGAUTHORITYANDLANGUAGEMEDIUMDATA(
...
export const PAPERGRADE = (
  ...
  if (
    ...
    return (
      <div className="row">
        <div className="col-md-8" css={SOR_MERIT_MARGIN}>
          {papergrade}
        </div>
      </div>
    );
...
export const SUBJECTNAME = (
  ...
  if (examlvltype === "PSLE1979") {
    return (
      <div className="row">
        <div className="col-md-3" />
        <div className="col-md-8" css={SOR_PSLE_NAME_1979}>
          {subjectname}
        </div>
      </div>
    );
...
export const ADDITIONALINFO = (
  ...
  return (
    <span>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;
      <span css={SOR_TRANSCRIPT_FONT_SIZE_11}>
...
export const RENDER_SOR_HEADER = ({ document }) => {
	return(
	  <div className="row">
		<div className="col-md-12">
		  <div className="row">
			<div className="col-md-12" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
		  ...
		  <div className="row">
			<div className="col-md-12" css={EXAM_LVL_TEXT}>
			  {document.name}
			</div>
		  </div>
		</div>
...
export const RENDER_SOR_FOOTER = ({ document }) => (
  <div className="row" css={SOR_TRANSCRIPT_FONT_SIZE_11}>
    <div className="col-md-12">
      <div className="row">
        <div className="col-md-12" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
      ...
      <div className="row">
        <div className="col-md-2" css={SOR_INDENT_TEXT}>
          <img
            width="50px"
            height="80px"
            src={document.additionalData.certifierSignature}
          />
        </div>
      ...
      <div className="row">
        <div className="col-md-12">
          {document.additionalData.certifierName}
          <div className="row">
            <div className="col-md-6">
              {document.additionalData.certifierDesignation}
            </div>
            <div className="col-md-6">
              <div className="row">
                <div className="col-md-12" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
...
export const RENDER_SOR_INFO = ({ document }) => (
  <div className="row">
    <div className="col-md-12">
      <div className="row">
        <div className="col-md-12" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
          ...
          <span css={SOR_TRANSCRIPT_FONT_SIZE_11}>
            {FORMATYEARPREFIX(document.attainmentDate)}
          </span>
        </div>
      </div>
      <div className="row">&nbsp;</div>
      ...
      <div className="row">&nbsp;</div>
      <div className="row">
        <div className="col-md-6" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
          <strong>NRIC/Foreign Identification No.</strong>
          &nbsp;&nbsp;&nbsp;&nbsp;
          <span css={SOR_TRANSCRIPT_FONT_SIZE_11}>
            {GETIDENTIFICATION(document)}
          </span>
        </div>
        <div className="col-md-6" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
          <strong>Index No.</strong>&nbsp;&nbsp;&nbsp;&nbsp;
          <span css={SOR_TRANSCRIPT_FONT_SIZE_11}>
            {document.additionalData.indexNo}
          </span>
        </div>
      </div>
    </div>
...
export const RENDER_SOR_INFO_PSLE = ({ document }) => (
  <div className="row">
    <div className="col-md-12">
      <div className="row">
        <div className="col-md-2" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
          <strong>held in the year</strong>
        </div>
        <div className="col-md-10" css={SOR_TRANSCRIPT_FONT_SIZE_11}>
          {FORMATYEARPREFIX(document.attainmentDate)}
        </div>
      </div>
      <div className="row">&nbsp;</div>
      ...
      <div className="row">
        <div className="col-md-12" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span css={SOR_TRANSCRIPT_FONT_SIZE_11}>
            {document.additionalData.schoolName}
          </span>
        </div>
      </div>
      <div className="row">
        <div className="col-md-4" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
          <strong>NRIC/Foreign Identification No.</strong>
        </div>
        <div className="col-md-2" css={SOR_TRANSCRIPT_FONT_SIZE_11}>
          {GETIDENTIFICATION(document)}
        </div>
        <div className="col-md-2" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
          <strong>Index No.</strong>
        </div>
        <div className="col-md-4" css={SOR_TRANSCRIPT_FONT_SIZE_11}>
          {document.additionalData.indexNo}
        </div>
      </div>
    </div>
...
export const GETESORTYPE = (document, examlvl) => {
  let infotype = "";
  if (examlvl === "PSLE") {
    infotype = RENDER_SOR_INFO_PSLE(document);
  } else {
    infotype = RENDER_SOR_INFO(document);
  }

  return infotype;
};

export const RENDER_TRANSCRIPT = ({ document }, examlvl, examlvltype) => {
  // Get transcript info
  const transcript = get(document, "transcript");
  const totalsubjects = transcript.length;
  const examyr = FORMATYEARPREFIX(document.attainmentDate);

  const transcriptDetails = transcript.map(trn => (
    <div className="row" css={SOR_TRANSCRIPT_FONT_SIZE_11} key={trn.name}>
      <div className="col-md-12">
        <div className="row">
          <div className="col-md-4" css={SOR_SUBJECT_REM_RIGHT_PAD}>
            {SUBJECTNAME(
              examlvltype,
              trn.name,
  ...
  return (
    <div className="row" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
      <div className="col-md-12">
        <div className="row">
          <div className="col-md-12">&nbsp;</div>
        </div>
        ...
        <div className="row">
          <div className="col-md-12" css={SOR_TRANSCRIPT_FONT_SIZE_12}>
            {ADDITIONALINFO(
              examlvltype,
              totalsubjects,
              document.additionalData.aggregateScore,
              document.additionalData.overallResults,
              document.additionalData.streamEligibleFor,
              document.additionalData.highestAggregateScore,
              document.additionalData.lowestAggregateScore
            )}
          </div>
        </div>
      </div>
...
export const TEMPLATE_ESOR = (document, examlvl, examlvltype) => (
  <div className="container-fluid">
    <div className="row justify-content-md-center">
      <div className="col-md-2" />
      <div className="col-md-8" css={GETESORBGCOLOR(examlvl)}>
        <div className="col-md-12">
          <div className="row">
            <div className="col-md-12">&nbsp;</div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-11" css={SOR_TOP_HEADER}>
          ...
          <div className="row">
            <div className="col-md-12" css={SOR_TITLE}>
          ...
          <div className="row">
            <div className="col-md-12">{RENDER_SOR_HEADER({document})}</div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">{GETESORTYPE({document}, examlvl)}</div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">
              {RENDER_TRANSCRIPT({document}, examlvl, examlvltype)}
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12">{RENDER_SOR_FOOTER({document})}</div>
          </div>
        </div>
      </div>
      <div className="col-md-2" />
...
export const TEMPLATE_EXPLANATORYNOTES = examlvltype => (
  <div className="container-fluid">
    <div className="row justify-content-md-center">
      <div className="col-md-2" />
      <div className="col-md-8" css={EXPLANATORY_PAGE_SIZE}>
        <div className="col-md-12">
          <div className="row">
            <div className="col-md-12">&nbsp;</div>
          </div>
          <div className="row">
            <div className="col-md-12" css={EXPLANATORY_TITLE}>
              EXPLANATORY NOTES
            </div>
          </div>
        </div>
