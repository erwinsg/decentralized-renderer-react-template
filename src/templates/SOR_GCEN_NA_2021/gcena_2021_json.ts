...
export const gcena2021TemplateCertificate: GCENA2021TemplateCertificate = {
    attainmentDate: "2021-01-01T17:37:15+08:00",
    transcript: [
	  {
        grade: "1",
        level: "NORMAL",
        name: "ENGLISH LANGUAGE SYLLABUS A",
    ...
    id: "SOR_ALL_2021GCENNA1001/00022019-02-27",
    additionalData: {
