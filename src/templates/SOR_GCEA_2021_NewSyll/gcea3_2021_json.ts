...
export interface GCEA32021TemplateCertificate extends v2.OpenAttestationDocument {
...
export const gcea32021TemplateCertificate: GCEA32021TemplateCertificate = {
    attainmentDate: "2015-12-31T23:59:00+08:00",
    transcript: [
      {
        level: "H1",
        paperGrade: "PASS",
